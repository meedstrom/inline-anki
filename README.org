...
- [ ] Define some expressions for a traditional front-back note-type instead of cloze-deletion.
  - [ ] A parameter for =#+begin_flashcard=.  Then interpret the last paragraph as the back side.
...
- [ ] Instruct the user on how to make Anki open emacsclient when they click a =file://= link.
